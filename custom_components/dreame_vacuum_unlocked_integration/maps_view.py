...
MAPS_API_PATH = "/api/dreame_vacuum_unlocked_integration/maps/{did}"


class DreameMapsView(HomeAssistantView):
    """GET /api/dreame_vacuum_unlocked_integration/maps/<did>"""

    url = MAPS_API_PATH
    name = "api:dreame_vacuum_unlocked_integration:maps"
    requires_auth = True
